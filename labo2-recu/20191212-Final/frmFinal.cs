...
namespace Final
{
    public partial class frmFinal : Form
    {
        ...
        private void btnPunto4_Click(object sender, EventArgs e)
        {
            ...
            // Al sumar una canasta con un elemento del ReinoVegetal se deberá agregar a la lista de plantas
        ...
        {
          //  MessageBox.Show("Realizar un Test Unitario que pruebe que la excepción NoAgregaException se lance al estar llena la Canasta.");
        ...
        {
            Thread nuevoHilo = new Thread(this.ProbarTodo);
